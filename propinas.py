...
personas=int(input("Ingrese por cuantas personas divide la cuenta: "))
division=total_cuenta/personas
...
print(f"Al dividir la cuenta para {personas}, cada uno debe pagar {division}")